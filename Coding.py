...
# 4
fig = go.Figure()
plot_compare2(fig, stocks, 'Entire Period')
fig

fig = go.Figure()
plot_compare2(fig, stocks_bear_market, 'Bear Market')
fig

fig = go.Figure()
plot_compare2(fig, stocks_bull_market, 'Bull Market')
fig

fig = go.Figure()
plot_compare2(fig, stocks_covid_market, 'Covid Period')
fig
